 ...
 *
 * STT_NDARRAY — Start streaming NDARRAY messages. Per query.md, body is empty; streaming cadence is server-determined.
 */
#ifndef OIGTL_C_MESSAGES_STT_NDARRAY_H
#define OIGTL_C_MESSAGES_STT_NDARRAY_H
...
/* Fixed body size — every wire-valid STT_NDARRAY has this
 * many body bytes. Useful for stack-sizing a pack buffer. */
#define OIGTL_STT_NDARRAY_BODY_SIZE ((size_t)0)

typedef struct oigtl_stt_ndarray {
...
int oigtl_stt_ndarray_packed_size(const oigtl_stt_ndarray_t *msg);
...
int oigtl_stt_ndarray_pack(const oigtl_stt_ndarray_t *msg,
...
#endif /* OIGTL_C_MESSAGES_STT_NDARRAY_H */
