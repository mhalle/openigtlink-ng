 ...
 *
 * STP_POSITION — Stop streaming POSITION messages previously started by STT_POSITION.
 */
#ifndef OIGTL_C_MESSAGES_STP_POSITION_H
#define OIGTL_C_MESSAGES_STP_POSITION_H
...
/* Fixed body size — every wire-valid STP_POSITION has this
 * many body bytes. Useful for stack-sizing a pack buffer. */
#define OIGTL_STP_POSITION_BODY_SIZE ((size_t)0)

typedef struct oigtl_stp_position {
...
#endif /* OIGTL_C_MESSAGES_STP_POSITION_H */
