 ...
 *
 * STP_QTDATA — Stop streaming QTDATA messages previously started by STT_QTDATA.
 */
#ifndef OIGTL_C_MESSAGES_STP_QTDATA_H
#define OIGTL_C_MESSAGES_STP_QTDATA_H
...
/* Fixed body size — every wire-valid STP_QTDATA has this
 * many body bytes. Useful for stack-sizing a pack buffer. */
#define OIGTL_STP_QTDATA_BODY_SIZE ((size_t)0)

typedef struct oigtl_stp_qtdata {
...
int oigtl_stp_qtdata_packed_size(const oigtl_stp_qtdata_t *msg);
...
int oigtl_stp_qtdata_pack(const oigtl_stp_qtdata_t *msg,
...
int oigtl_stp_qtdata_unpack(const uint8_t *buf, size_t len,
                                oigtl_stp_qtdata_t *out);

#ifdef __cplusplus
}
#endif

#endif /* OIGTL_C_MESSAGES_STP_QTDATA_H */
