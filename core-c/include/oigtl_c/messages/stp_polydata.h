 ...
 *
 * STP_POLYDATA — Stop streaming POLYDATA previously started by STT_POLYDATA.
 */
#ifndef OIGTL_C_MESSAGES_STP_POLYDATA_H
#define OIGTL_C_MESSAGES_STP_POLYDATA_H
...
/* Fixed body size — every wire-valid STP_POLYDATA has this
 * many body bytes. Useful for stack-sizing a pack buffer. */
#define OIGTL_STP_POLYDATA_BODY_SIZE ((size_t)0)

typedef struct oigtl_stp_polydata {
...
int oigtl_stp_polydata_packed_size(const oigtl_stp_polydata_t *msg);
...
int oigtl_stp_polydata_pack(const oigtl_stp_polydata_t *msg,
...
#endif /* OIGTL_C_MESSAGES_STP_POLYDATA_H */
