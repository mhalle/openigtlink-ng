...
"""RTS_QTRANS message — typed Python wire codec."""
...
class RtsQtrans(BaseModel):

    TYPE_ID: ClassVar[str] = "RTS_QTRANS"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "RtsQtrans":
        """Decode wire body bytes into a :class:`RtsQtrans` instance."""
