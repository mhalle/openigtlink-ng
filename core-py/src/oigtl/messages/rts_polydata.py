...
"""RTS_POLYDATA message — typed Python wire codec."""
...
class RtsPolydata(BaseModel):

    TYPE_ID: ClassVar[str] = "RTS_POLYDATA"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "RtsPolydata":
        """Decode wire body bytes into a :class:`RtsPolydata` instance."""
