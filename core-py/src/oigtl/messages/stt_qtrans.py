...
"""STT_QTRANS message — typed Python wire codec."""
...
class SttQtrans(BaseModel):

    TYPE_ID: ClassVar[str] = "STT_QTRANS"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "SttQtrans":
        """Decode wire body bytes into a :class:`SttQtrans` instance."""
