...
"""STP_POSITION message — typed Python wire codec."""
...
class StpPosition(BaseModel):

    TYPE_ID: ClassVar[str] = "STP_POSITION"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "StpPosition":
        """Decode wire body bytes into a :class:`StpPosition` instance."""
