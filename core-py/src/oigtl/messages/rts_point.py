...
"""RTS_POINT message — typed Python wire codec."""
...
class RtsPoint(BaseModel):

    TYPE_ID: ClassVar[str] = "RTS_POINT"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "RtsPoint":
        """Decode wire body bytes into a :class:`RtsPoint` instance."""
