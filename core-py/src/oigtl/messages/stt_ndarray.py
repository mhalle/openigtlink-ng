...
"""STT_NDARRAY message — typed Python wire codec."""
...
class SttNdarray(BaseModel):

    TYPE_ID: ClassVar[str] = "STT_NDARRAY"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "SttNdarray":
        """Decode wire body bytes into a :class:`SttNdarray` instance."""
