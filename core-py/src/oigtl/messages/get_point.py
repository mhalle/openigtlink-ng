...
"""GET_POINT message — typed Python wire codec."""
...
class GetPoint(BaseModel):
    TYPE_ID: ClassVar[str] = "GET_POINT"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "GetPoint":
        """Decode wire body bytes into a :class:`GetPoint` instance."""
