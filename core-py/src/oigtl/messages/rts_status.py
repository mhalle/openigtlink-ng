...
"""RTS_STATUS message — typed Python wire codec."""
...
class RtsStatus(BaseModel):
    ...
    TYPE_ID: ClassVar[str] = "RTS_STATUS"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "RtsStatus":
        """Decode wire body bytes into a :class:`RtsStatus` instance."""
