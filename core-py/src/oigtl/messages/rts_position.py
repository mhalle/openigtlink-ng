...
"""RTS_POSITION message — typed Python wire codec."""
...
class RtsPosition(BaseModel):

    TYPE_ID: ClassVar[str] = "RTS_POSITION"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "RtsPosition":
        """Decode wire body bytes into a :class:`RtsPosition` instance."""
