...
"""STT_TRANS message — typed Python wire codec."""
...
class SttTrans(BaseModel):

    TYPE_ID: ClassVar[str] = "STT_TRANS"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "SttTrans":
        """Decode wire body bytes into a :class:`SttTrans` instance."""
