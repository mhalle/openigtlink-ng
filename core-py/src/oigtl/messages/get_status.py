...
"""GET_STATUS message — typed Python wire codec."""
...
class GetStatus(BaseModel):
    TYPE_ID: ClassVar[str] = "GET_STATUS"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "GetStatus":
        """Decode wire body bytes into a :class:`GetStatus` instance."""
