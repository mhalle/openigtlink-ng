...
"""RTS_CAPABIL message — typed Python wire codec."""
...
class RtsCapabil(BaseModel):

    TYPE_ID: ClassVar[str] = "RTS_CAPABIL"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "RtsCapabil":
        """Decode wire body bytes into a :class:`RtsCapabil` instance."""
