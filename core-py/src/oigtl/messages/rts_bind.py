...
"""RTS_BIND message — typed Python wire codec."""
...
class RtsBind(BaseModel):

    TYPE_ID: ClassVar[str] = "RTS_BIND"
    ...
    @classmethod
    def unpack(cls, data: bytes) -> "RtsBind":
        """Decode wire body bytes into a :class:`RtsBind` instance."""
